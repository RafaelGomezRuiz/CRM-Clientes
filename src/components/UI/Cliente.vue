...
<template>
    <tr>
        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-0">
            <p class="font-medium text-white-900">{{nombreCliente}}</p>
        ...
        <td class="whitespace-nowrap px-3 py-4 text-sm">
            <button class="inline-flex rounded-full px-2 text-xs font-semibold leading-5"
                :class="[estadoCliente ? 'bg-green-100 text-green-800' 
        ...
        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 gap-4">
            <RouterLink 
